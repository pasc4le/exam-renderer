...
document.addEventListener("alpine:init", () => {
    window.Alpine.data("exam", () => ({
        ...
        async generateExam() {
            ...
            this.streamingOutput = ''; // Reset buffer
...
The user will provide a topic or description. Ensure valid JSON output. Do not wrap in markdown code blocks.`;
                ...
                // Use selected model. SDK usually handles "models/" prefix fine or we can strip it.
                // But let's strip it to be cleaner: "models/gemini-1.5-flash" -> "gemini-1.5-flash"
                const modelName = this.selectedModel.replace('models/', '') || "gemini-1.5-flash";
                ...
                // attach inline data - SDK expects specific format for inline data
                ...
                for await (const chunk of result.stream) {
                    ...
                    fullText += chunkText;
                    this.streamingOutput = fullText; // Update UI
                }
